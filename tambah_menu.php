        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            <div class="control-group">
              <label class="control-label">Nama Ikan:</label>
              <div class="controls">
                <?php 
                  if(isset($_SESSION['edit_menu'])){
                ?>
                  <input name="" type="text" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Ikan" disabled=""/>
                  <input name="nama_masakan" type="hidden" value="<?php echo $nama_masakan; ?>" class="span11" placeholder="Nama Ikan"/>
                <?php
                  } else {
                ?>
                  <input name="nama_masakan" type="text" value="" class="span11" placeholder="Nama Ikan"/>
                <?php
                  }
                ?>
              </div>
            ...
            <div class="control-group">
              <label class="control-label">Gambar Ikan :</label>
              <div class="control-group">
                <div class="controls">
