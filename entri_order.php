...
<?php 
						if(isset($_SESSION['harga_negatif'])){
					?>
						<div class='container'>	
							<div class = 'alert alert-danger'>
								<span>
									<center>Harga tidak bisa negatif</center>
								</span>
							</div> 
						</div>
					<?php 
						unset($_SESSION['harga_negatif']);
						}
?>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            ?>
              <div class="row-fluid">
                  ...
                  <div class="widget-box span12">
                    ...
                    <div class="widget-content">
                      <div class="alert alert-info alert-block">
                        ...
                        Silahkan lakukan pembayaran pada scan barcode, agar pesanan anda segera diproses !
                      </div>
                    </div>
                  </div>
                </div>
                <div class="span6">
                      ...
                      <table class="table table-bordered table-invoice-full">
                        <thead>
                          <tr>
                            ...
                            <th class="head0 right">Jumlah/kg</th>
                  ...
                  <h4>Silahkan scan dibawah ini untuk membayar</h4>
                  <img src="gambar/barcode.jpeg" width="100">
                </div>
              </div>
            <?php
            } else {
                    ...
                    <div class="widget-box">
                        ...
                        <table class="table table-bordered table-striped">
                          <thead>
                            <tr>
                              ...
                              <th style="width: 30%">Jumlah/Kg</th>
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr class="odd gradeX">
                                ...
                                <td>
                                  <center>
                                    <input id="<?php echo "jumlah" . $r_draft_pesan['id_pesan']; ?>" class="span8" name="jumlah<?php echo $r_draft_pesan['id_masakan']; ?>" type="number" value="" placeholder="" onchange="return operasi()" min="1"/>
                                  </center>
                                </td>
                                <td>
                                  <form action="" method="post">
                                    <button type="submit" value="<?php echo $r_draft_pesan['id_pesan']; ?>" name="hapus_pesan" class="btn btn-danger">
                                      Hapus
                                    </button>
                                  </form>
                                </td>
                            ...
                            <!-- <tr class="odd gradeX">
                              ...
                              <td>
                                <center>
                                  <input class="span8" name="no_meja" type="text" value="" placeholder="" />
                                </center>
                              </td>
                              <td>
                            ...
                            <!-- <tr>
                              ...
                              <td>
                                <center>
                                <div>
                                  <input id="alamat" class="input-text" type="text" name="" >
                                  <label for="alamat" class="label"></label>
                                </div>
                                </center>
                              </td>
                            </tr> -->
                      ...
                      <div class="widget-content nopadding">
                        <table class="table table-bordered table-striped">
                          <thead>
                            <tr>
                              <th style="width: 46%">Data Diri</th>
                              <th style="width: 54%">Masukan Alamat</th>
                              <!-- <th style="width: 20%">Aksi</th> -->
                            </tr>
                          </thead>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <center>
                                <div>
                                  <input id="alamat" class="input-text" type="text" name="alamat" >
                                  <label for="alamat" class="label"></label>
                                </div>
                                </center>
                              </td>
          ...
          <?php
            ...
            if (isset($_POST['proses_pesan'])) {
              ...
              $time = Date('YmdHis');
              echo $time;
              $query_simpan_order = "insert into tb_order values('', '$id_admin', '$id_pengunjung', $time, '$no_meja', '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order', '$alamat')";
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Application <a href="#">by DseefishCorp</a> </div>
      </div>
